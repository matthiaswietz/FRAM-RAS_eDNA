---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 18S rRNA amplicons (run CW5KV)"
---
...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_CW5KV.txt

# Some samples were re-sequenced due to MiSeq error
# Filenames are still the same; except run-ID
# Only keep those from correct run CW5KV
# Delete run CG63D
rm -rf *CG63D*

# Rename / remove MiSeq run-ID 
rename 'M03457_0040_000000000-CW5KV' 'CW5KV' *
cd CW5KV
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/CW5KV")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/CW5KV/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_euk_CW5KV.rds")

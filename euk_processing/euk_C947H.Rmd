---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 18S rRNA amplicons (run C947H)"
---
...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_C947H.txt

# Rename / remove MiSeq run-ID 
rename 'M03457_0031_000000000-C947H' 'C947H' *
cd C947H
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/C947H")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/C947H/Clipped"
fns <- list.files(path)
fns
...
# some outliers outside black line - but acceptable
...
# Save
saveRDS(seqtab, "seqtab_euk_C947H.rds")
...
write.table(track, 
  "dadastats_euk_C947H.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_euk_C947H.Rdata")

---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 18S rRNA amplicons (run K3N66)"
---

This markdown describes the processing of 18S rRNA amplicon sequences, originating from continuous year-round sampling by "Remote Access Samplers" in the framework of the FRAM LTER  (https://www.awi.de/en/expedition/observatories/ocean-fram.html). The corresponding raw fastq files are available under ENA accession XXX. 
...
#cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS/bacteria
# mkdir -p JR82J/{Original}
# cd JR82J/Original
  
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/K3N66/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/K3N66")

# link & list clipped files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/K3N66/Clipped"
fns <- list.files(path)
fns
...
dim(seqtab) # 4767 sequences
saveRDS(seqtab, 
  "seqtab_euk_K3N66.rds")

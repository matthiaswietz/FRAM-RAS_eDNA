---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 18S rRNA amplicons (run CG5TF)"
---
...
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/CG5TF/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/CG5TF")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/CG5TF/Clipped"
fns <- list.files(path)
fns
...
# Should retaining >70% -- 0.8 here -- good
head(out)
summary(out[, 2]/out[, 1])
...
dim(seqtab) # 5671 sequences
saveRDS(seqtab, 
  "seqtab_euk_CG5TF.rds")
...
write.table(track, 
  "dadastats_euk_CG5TF.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_euk_CG5TF.Rdata")

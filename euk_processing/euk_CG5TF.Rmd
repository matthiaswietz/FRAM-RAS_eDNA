---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 18S rRNA amplicons (run CG5TF)"
---
...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_CG5TF.txt

# Rename / remove MiSeq run-ID 
rename 'M03457_0041_000000000-CG5TF' 'CG5TF' *
cd CG5TF
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/CG5TF")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/CG5TF/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_euk_CG5TF.rds")

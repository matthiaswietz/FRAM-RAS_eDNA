---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 18S rRNA amplicons (run JR82J)"
---

This markdown describes the processing of 18S rRNA amplicon sequences, originating from continuous year-round sampling by "Remote Access Samplers" in the framework of the FRAM LTER.

Primer clipping using *Cutadapt* 

```{console}

cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/JR82J/
mkdir Original
cd Original

# Custom script to fetch fastqs from TapeArchive
# Files are listed in "files2cp.txt"
/global/AWIsoft/bio/scripts/getFastqsFromTape.sh ../files2cp.txt

# Custom script to remove MiSeq-ID from filenames
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/JR82J")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/JR82J/Clipped"
fns <- list.files(path)
fns
...
dev.off()
rm(QualityProfileRs)
# looking OK, but many reads in NK 30-35 cycles
...
dim(seqtab) # 2236 sequences
saveRDS(seqtab, 
  "seqtab_euk_JR82J.rds")
...
write.table(track, 
  "dadastats_euk_JR82J.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_euk_JR82J.Rdata")

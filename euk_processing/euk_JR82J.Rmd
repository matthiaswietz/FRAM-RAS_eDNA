---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 18S rRNA amplicons (run JR82J)"
---
...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_JR82J.txt

# Rename / remove MiSeq run-ID 
rename 'M03457_0084_000000000-JR82J' 'JR82J' *
cd JR82J
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/JR82J")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/JR82J/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_euk_JR82J.rds")

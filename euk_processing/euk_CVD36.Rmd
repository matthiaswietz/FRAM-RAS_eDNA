---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 18S rRNA amplicons (run CVD36)"
---
...
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/CVD36/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/CVD36")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/CVD36/Clipped"
fns <- list.files(path)
fns
...
dim(seqtab) # 20358 sequences
saveRDS(seqtab, 
  "seqtab_euk_CVD36.rds")
...
write.table(track, 
  "dadastats_euk_CVD36.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_euk_CVD36.Rdata")

...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_CVD36.txt

# Rename / remove MiSeq run-ID 
rename 'M03457_0044_000000000-CVD36' 'CVD36' *
cd CVD36
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/CVD36")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/CVD36/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_euk_CVD36.rds")

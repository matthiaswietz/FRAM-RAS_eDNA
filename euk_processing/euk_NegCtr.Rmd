---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 18S rRNA amplicons (negative controls)"
---

This markdown describes the processing of negative PCR/sequencing controls from 18S rRNA amplicon-sequencing within the FRAM LTER. Raw fastq files are available under ENA umbrella PRJEB43905.
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/NegCtr")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/NegCtr/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_euk_NegCtr.rds")
...
write.table(track, 
  "dadastats_euk_NegCtr.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_euk_NegCtr.Rdata")

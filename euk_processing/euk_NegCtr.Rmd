---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 18S rRNA amplicons (negative controls)"
---

Negative PCR/sequencing controls associated with year-round sampling by "Remote Access Samplers" in the framework of the FRAM LTER.

First we remove primers using *Cutadapt*  

```{console}

cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/NegCtr/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/NegCtr")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/NegCtr/Clipped"
fns <- list.files(path)
fns
...
dim(seqtab) # 77 sequences
saveRDS(seqtab, 
  "seqtab_euk_NegCtr.rds")

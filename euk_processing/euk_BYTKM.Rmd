---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 18S rRNA amplicons (run BYTKM)"
---

This markdown describes the processing of 18S rRNA amplicon sequences, originating from continuous year-round sampling by "Remote Access Samplers" in the framework of the FRAM LTER  (https://www.awi.de/en/expedition/observatories/ocean-fram.html). 
...
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/BYTKM/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/BYTKM")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/eukaryotes/BYTKM/Clipped"
fns <- list.files(path)
fns
...
dim(seqtab) # 23088 sequences
saveRDS(seqtab, 
  "seqtab_euk_BYTKM.rds")
...
write.table(track, 
  "dadastats_euk_BYTKM.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_euk_BYTKM.Rdata")

---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 18S rRNA amplicons (run BYTKM)"
---
...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_BYTKM.txt

# Rename / remove MiSeq run-ID 
rename 'M03457_0017_000000000-BYTKM' 'BYTKM' *
cd BYTKM
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/BYTKM")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/eukaryotes/BYTKM/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_euk_BYTKM.rds")

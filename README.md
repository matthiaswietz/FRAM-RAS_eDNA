...
The repo covers all steps from primer clipping to the generation of amplicon sequence variants (ASVs). Reads were obtained by PCR with 16S and 18S rRNA primers, followed by [Cutadapt primer clipping](https://cutadapt.readthedocs.io/en/stable/), Illumina MiSeq sequencing, and ASV generation via [DADA2](https://benjjneb.github.io/dada2/tutorial_1_8.html). 

...
This repo describes ribosomal metabarcoding of environmental DNA (eDNA), collected using autonomous Remote Access Samplers (RAS) in the [FRAM long-term observatory](https://www.awi.de/en/expedition/observatories/ocean-fram.html) of the Alfred Wegener Institute Helmholtz Centre for Polar and Marine Research. Scripts are however generalizable to any ribosomal metabarcoding of eDNA. 

---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 16S rRNA amplicons (run JK6MD)"
---
...
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/JK6MD/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/JK6MD")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/JK6MD/Clipped"
fns <- list.files(path)
fns
...
dim(seqtab) # 6655 sequences
saveRDS(seqtab, 
  "seqtab_bac_JK6MD.rds")

---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 16S rRNA amplicons (run JB7R9)"
---

This markdown describes the processing of 16S rRNA amplicon sequences, originating from continuous year-round sampling by "Remote Access Samplers" in the framework of the FRAM LTER.

Primer clipping using *Cutadapt* 

```{console}

cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/JB7R9/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/JB7R9")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/JB7R9/Clipped"
fns <- list.files(path)
fns

---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 16S rRNA amplicons (run J34R3)"
---
...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_J34R3.txt

# Rename / remove MiSeq run-ID 
rename 'MISEQ_475_000000000-J34R3' 'J34R3' *
cd J34R3
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/bacteria/J34R3")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/bacteria/J34R3/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_bac_J34R3.rds")
...
write.table(track, 
  "dadastats_bac_J34R3.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_bac_J34R3.Rdata")

---
title: "FRAM Observatory -- Remote Access Samplers -- Processing of 16S rRNA amplicons (run BLWBG)"
---

This markdown describes the processing of 16S rRNA amplicon sequences, originating from continuous sampling over annual cycles by "Remote Access Samplers" within the FRAM LTER  (https://www.awi.de/en/expedition/observatories/ocean-fram.html). 

Primer clipping using *Cutadapt*  

```{console}

cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/BLWBG/
mkdir Original
cd Original
...
# remove 3413 sample with id BLVR5 (naming error - duplicate)
rm *BLVR5_3413*
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/BLWBG")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/BLWBG/Clipped"
fns <- list.files(path)
fns

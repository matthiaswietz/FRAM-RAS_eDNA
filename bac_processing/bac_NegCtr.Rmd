---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 16S rRNA amplicons (negative control runs)"
---
...
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/NegCtr/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/NegCtr")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/NegCtr/Clipped"
fns <- list.files(path)
fns

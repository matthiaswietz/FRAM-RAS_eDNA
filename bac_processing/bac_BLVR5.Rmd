---
title: "FRAM Observatory -- Remote Access Samplers -- Processing of 16S rRNA amplicons (run BLVR5)"
---
...
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/BLVR5/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/BLVR5")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/BLVR5/Clipped"
fns <- list.files(path)
fns
...
dim(seqtab) # 10131 sequences
saveRDS(seqtab, 
  "seqtab_bac_BLVR5.rds")

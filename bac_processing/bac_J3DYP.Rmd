---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 16S rRNA amplicons (run J3DYP)"
---
...
/isibhv/projects/p_bioinf2/miseq/copy-files-from-tape.sh files_J3DYP.txt

# Rename / remove MiSeq run-ID 
rename 'MISEQ_474_000000000-J3DYP' 'J3DYP' *
cd J3DYP
mkdir Original 
mv *gz Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/bacteria/J3DYP")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/bacteria/J3DYP/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_bac_J3DYP.rds")

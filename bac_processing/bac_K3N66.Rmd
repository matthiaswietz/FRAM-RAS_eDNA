---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- 16S rRNA amplicons (run K3N66)"
---
...
# setwd 
setwd("/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/bacteria/K3N66")

# list files
path <- "/isibhv/projects/FRAMdata/MolObs/WaterCol_RAS_ampTimeseries/bacteria/K3N66/Clipped"
fns <- list.files(path)
fns
...
# Save
saveRDS(seqtab, "seqtab_bac_K3N66.rds")

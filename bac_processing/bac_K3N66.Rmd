---
title: "FRAM OBSERVATORY -- Remote Access Samplers -- Processing of 16S rRNA amplicons (run K3N66)"
---
...
# mkdir -p K3N66/{Original}
# cd JR82J/Original
  
cd /isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/K3N66/
mkdir Original
cd Original
...
# setwd 
setwd("/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/K3N66")

# list files
path <- "/isibhv/projects/FRAMdata/FRAM_MicrObs/WaterCol_RAS_1620/bacteria/K3N66/Clipped"
fns <- list.files(path)
fns
...
dim(seqtab) # identified 7590 sequences
saveRDS(seqtab, 
  "seqtab_bac_K3N66.rds")
...
write.table(track, 
  "dadastats_bac_K3N66.txt", 
  quote=F, sep="\t")

#################################

save.image("RAS_bac_K3N66.Rdata")
